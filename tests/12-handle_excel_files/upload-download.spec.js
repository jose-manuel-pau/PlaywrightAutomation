...
test('Upload download excel Validations',async ({page})=>
{
    ...
    await writeExcel("Mango",350,{rowChange:0,colChange:2},"/home/jm-pau/Proyects/PlayWrightAutomation/downloads/download.xlsx").catch(console.error);
    await page.locator("#fileinput").click();
    await page.locator("#fileinput").setInputFiles("/home/jm-pau/Proyects/PlayWrightAutomation/downloads/download.xlsx");
