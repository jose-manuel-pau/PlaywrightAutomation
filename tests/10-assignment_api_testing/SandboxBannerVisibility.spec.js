...
const EMAIL = 'josemanuelpau@capitole-consulting.com';
const PASSWORD = 'ET!ViXedFk9uJUX';
...
test('Banner IS visible when 6 events are returned', async ({ page }) => {
    ...
    console.log('\x1b[32m%s\x1b[0m', 'Test passed successfully Banner is visible, Congratulations!!!');
});
...
test('Banner is NOT visible when 4 events are returned', async ({ page }) => {
    ...
    console.log('\x1b[32m%s\x1b[0m', 'Test passed successfully Banner is not visible, Congratulations!!!');
});
